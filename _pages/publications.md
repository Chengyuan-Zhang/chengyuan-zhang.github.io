...
1. **Chengyuan Zhang**, Cathy Wu, and Lijun Sun* (2025). Markov Regime-Switching Intelligent Driver Model for
   Interpretable
   Car-Following Behavior. [[arXiv](https://arxiv.org/pdf/2506.14762)] [code coming soon]
2. **Chengyuan Zhang**, Zhengbing He, Cathy Wu, and Lijun Sun* (2025). When Context Is Not Enough: Modeling Unexplained
   Variability in Car-Following Behavior. [[arXiv](https://arxiv.org/abs/2507.07012)]
